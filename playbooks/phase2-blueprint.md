...
> 要件をもとに、UI設計・技術設計・データモデル・チーム計画を策定する
...
> **注意**: この時点ではラフ UI 設計に基づく暫定版。Phase 3 で UI が確定した後、必要に応じて改訂する。
...
2. **並列ストリームを設計する**
   - ui-design.md、architecture.md、data-model.md を分析し、独立して進められる作業を特定する
